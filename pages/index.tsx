  ...
  return (
    <div className="my-24 flex">
      <div className="absolute top-0 left-0 min-w-full -z-10">
        ...
        <rect fill="#ff5500" width="100%" height="10%"></rect>
        <path fill="#ff5500" fill-opacity="1" d="M0,32L48,53.3C96,75,192,117,288,138.7C384,160,480,160,576,149.3C672,139,768,117,864,128C960,139,1056,181,1152,192C1248,203,1344,181,1392,170.7L1440,160L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path>
      </svg>
      </div>
      <div className="w-2/3">
